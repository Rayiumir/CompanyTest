                            ...
                            <div class="card-body">
                                <form>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control rounded-5 @error('title') is-invalid @enderror" name="title" id="Input1" value="{{ $post->title }}">
                                        <div class="text-danger">@error('title') {{ $message }} @enderror</div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="Input2">لینک دانلود</label>
                                        <input type="text" class="form-control rounded-5 @error('metabox_field') is-invalid @enderror" id="Input2" name="metabox_field" value="{{ $post->getMetabox('metabox_field') }}">
                                        <div class="text-danger">@error('metabox_field') {{ $message }} @enderror</div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="Textarea1" class="form-label">متن</label>
                                        <textarea class="form-control rounded-4 @error('content') is-invalid @enderror" name="content" id="Textarea1" rows="3">{{ $post->content }}</textarea>
